...
# ============================================================================
# Load your dataset
data_path = "data/IMDB_Dataset.csv"  # Path to the IMDB movie reviews dataset
df = pd.read_csv(data_path, encoding='utf-8')  # IMDB dataset uses UTF-8 encoding
...
text_column = " review"    # The message text column
target_column = "sentiment"  # The label column (ham/spam)
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Blues',
            xticklabels=['Negative', 'Positive'],  # Class labels for predictions
            yticklabels=['Negative', 'Positive'])  # Class labels for actual values
...
# Test 1: A positive review
new_text = "This movie was absolutely brilliant! The acting was superb and the plot kept me engaged throughout."
prediction, probability = predict_text(new_text)
print("\nReview 1:", new_text)
print(f"Prediction: {prediction}")
print(f"Confidence: {max(probability):.2%}")

# Test 2: A negative review
new_text = "Terrible movie. Poor acting, weak plot, and a complete waste of time. Would not recommend."
prediction, probability = predict_text(new_text)
print("\nReview 2:", new_text)
print(f"Prediction: {prediction}")
print(f"Confidence: {max(probability):.2%}")

# Test 3: A mixed review
new_text = "While the cinematography was beautiful, the story was a bit slow and the characters underdeveloped."
prediction, probability = predict_text(new_text)
print("\nMessage 3:", new_text)
print(f"Prediction: {prediction}")
print(f"Confidence: {max(probability):.2%}")
